...
class ContactInfoForm(forms.ModelForm):
    ...
    contract_date = forms.DateField(
        required=False, label="Contract Date", input_formats=["%d/%m/%Y"]
    )
    ...
    assign_invalid_date = forms.DateField(
        required=False, label="Assign Invalid Date", input_formats=["%d/%m/%Y"]
    )
    ...
    date_start = forms.DateField(
        required=False, label="Date Start", input_formats=["%d/%m/%Y"]
    )
    date_end = forms.DateField(
        required=False, label="Date End", input_formats=["%d/%m/%Y"]
    )
