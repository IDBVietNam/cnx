    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "serial_number",
                    models.CharField(max_length=20, unique=True, verbose_name="STT"),
                ),
                (
                    "assigned_agent",
                ...
                (
                    "total_overdue",
                    models.IntegerField(blank=True, verbose_name="Total Overdue"),
                ),
                (
                    "tenor",
                ...
                (
                    "call_status",
                    models.CharField(
                        blank=True, max_length=50, verbose_name="Trạng thái gọi"
                    ),
                ),
                (
                    "recall_time",
                ...
                (
                    "call_result",
                    models.CharField(
                        blank=True, max_length=100, verbose_name="Kết quả gọi"
                    ),
                ),
